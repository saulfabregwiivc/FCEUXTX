...
void ResetControls(int consoleCtrl, int wiiCtrl)
{
	...
	{
		i=0;
		btnmap[CTRL_ZAPPER][CTRLR_CLASSIC][i++] = WPAD_CLASSIC_BUTTON_A; // shoot
	...
	{
		i=0;
		btnmap[CTRL_ZAPPER][CTRLR_WIIDRC][i++] = WIIDRC_BUTTON_A; // shoot
	...
	{
		i=0;
		btnmap[CTRL_ZAPPER][CTRLR_WUPC][i++] = WPAD_CLASSIC_BUTTON_A; // shoot
...
void GetJoy()
{
	...
	{
		fastforward = IsFastForwardInputPressed();
	}
