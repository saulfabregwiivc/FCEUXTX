...
extern int scanline;
extern int nwram;
extern uint8 minus_line; //mod: return timestamp to the past !!!
extern int cpuclock; //mod: alternative overclock(cpu timings)
extern uint8 stopclock; //mod: freeze timestamp by $401C
